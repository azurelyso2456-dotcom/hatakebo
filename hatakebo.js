...
const FAQ_DATA = [
  {
    ...
    "items": [
      {
        "q": "初めて使います。畑はどのように登録すればよいですか？",
        "a": [
          "まずは畑の幅と奥行きを選びましょう。最初から細部まで合わせなくても、登録した後に大きさや形を直せます。新しく登録する畑は、各辺50cm〜15m、25cm刻みで設定できます。",
          "四角くない畑は、畑全体が収まる幅と奥行きを選び、使わない場所のマスを外して形を近づけてください。木や物置がある場所も外せます。",
          "畑がいくつかある場合は、画面上部の「畑を追加」から別々に登録できます。「家の裏」「貸し農園」など、分かりやすい名前を付けておくと便利です。"
        ]
      },
      {
        "q": "ドラッグせずに畝を作りたいです",
      ...
      {
        "q": "畝がうまく収まらず、作成ボタンを押せません",
        "a": [
          "まず図を見ながら、畝を少し短くするか、空いている場所へ動かしてみてください。畑の外や使わない場所にはみ出したり、ほかの畝に重なったりすると、画面に理由が表示されます。",
          "「まとめて置く」では、畝の間の通路と周囲の余白も含めて配置します。畑の外側に歩ける通路がある場合は、「畑の外側に通路がある（余白なし）」を選べます。実際に歩いたり手を伸ばしたりできる広さに合わせてください。"
        ]
      },
      {
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "q": "スマホとパソコンで使いたいです。機種変更のときも引き継げますか？",
        "a": [
          "バックアップのファイルを渡すことで、別の端末へ記録を引き継げます。",
          {
            "type": "ol",
            "items": [
              "今までの端末で「⋯」→「バックアップ」を押す",
      ...
      },
      {
        ...
        "a": [
          ...
          "ブラウザの印刷画面で保存先に「PDF」が選べる場合は、紙に印刷せずファイルとして残せます。用紙の向きや図の収まりも、この画面で確認してください。",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        "q": "いつもの畑や記録が見当たりません",
        "a": [
          "記録を保存したときと同じ端末・同じブラウザで開いているか、まず確認してみてください。メールなどのアプリ内で開いた場合は、普段のブラウザで開くと見つかることがあります。畑のタブや表示中の年も確認してください。",
          "いつもと違うアドレスや確認用ページでは、保存先が別になります。普段使っているハタケボのアドレスから開いてみてください。",
          "それでも見つからないときは、保存してあるバックアップを「データを読込む」から戻せます。ブラウザのデータ消去やプライベートモードで記録が失われ、控えもない場合は復元できないため、残っている画面やファイルを消さずに確認しましょう。"
        ]
      },
      {
      ...
      {
        "q": "分からないことや、使いづらいところを相談したいです",
        "a": [
          "この画面の下にある「お問い合わせ」から、お気軽にお知らせください。「ここで止まってしまった」「こう使いたい」というお話だけでも、改善の助けになります。",
          "スマホかパソコンか、どのボタンを押したときに困ったか、画面に何が出たかを、分かる範囲で教えていただけると確認しやすくなります。画面の写真があれば、一緒にお送りください。",
          "住所や畑の詳しい所在地などは不要です。写真に個人情報が写っている場合は、隠してからお送りください。"
        ]
      }
    ]
  }
